<?php
    ...
    if (isset($_POST['insertUserBtn'])) {
        $insertUser = insertNewApplicant($pdo,$_POST['first_name'], $_POST['last_name'], $_POST['email'], $_POST['gender'], $_POST['address'], $_POST['nationality'],);
    ...
    if (isset($_POST['editUserBtn'])) {
        ...
        if ($id) {
            $updateSuccess = editUser($pdo, $first_name, $last_name, $email, $gender, $address, $nationality, $id);
            ...
            $insertSuccess = insertNewApplicant($pdo, $first_name, $last_name, $email, $gender, $address, $nationality);
